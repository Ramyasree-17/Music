-- =============================================
-- Update sp_CreateEnterprise_AutoOwner to include Phone parameter
-- =============================================
-- This adds Phone support to enterprise creation
...
CREATE PROCEDURE [dbo].[sp_CreateEnterprise_AutoOwner]
    ...
    @Phone NVARCHAR(20) = NULL,  -- ✅ Added Phone parameter
...
PRINT 'sp_CreateEnterprise_AutoOwner updated successfully with Phone parameter';
GO
